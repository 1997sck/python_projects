...
def write_to_csv(mail, writer, N, total_no_of_mails):
    ...
    for i in range(total_no_of_mails, total_no_of_mails - N, -1):
        ...
        if isinstance(response, tuple):
            ...
            # get header data
            email_subject = "For testing emails fetching from python imaplib and email libraries"
            email_from = "Sachin Raina <sachinraina07@gmail.com>"
            email_date = "Mon, 10 Aug 2020 13:24:18 +0530"
            email_text = "Purifying water involves filtering to remove large particles and treating by boiling or with chemicals to kill organisms such as bacteria, viruses and parasites. If you plan to use natural water along your adventure, follow these steps to collect and purify water from a natural water source"
